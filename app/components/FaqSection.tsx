...
const FAQS = [
  {
    ...
    a: "เรารองรับไฟล์ WAV, MP3, FLAC, M4A, OGG, AIFF และอื่น ๆ อีกมากมาย สูงสุดที่ไฟล์ขนาด 200MB หรือความยาว 30 นาทีต่อเพลง สำหรับแพ็กเกจ Free จำกัดที่ 3 เพลงต่อเดือน ส่วน PRO สามารถประมวลผลได้ไม่จำกัด",
  },
  {
