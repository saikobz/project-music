    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <input
          ...
          className="w-24 rounded-lg bg-[#0D0B0A] border border-[#2C2824] p-2 text-right text-[#F5F0EB] focus:border-[#F97316] focus:outline-none transition"
          disabled={loading}
        />
      </div>
      <input
        ...
        value={deltaClampDb}
        onChange={(e) => setDeltaClampDb(e.target.value)}
        className="w-full accent-[#E5A93D]"
        disabled={loading}
      />
