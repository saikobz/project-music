...
const WaveformPlayer: React.FC<WaveformPlayerProps> = ({ audioUrl }) => {
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-[#222] bg-[#0D0B0A] p-5 shadow-[0_10px_40px_rgba(0,0,0,0.5)]">
      ...
      <div className="space-y-4">
        ...
        {/* Volume control */}
        <div className="waveform-player-volume flex items-center gap-4 rounded-xl border border-[#222] bg-[#111] px-4 py-3">
